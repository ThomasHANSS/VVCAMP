var L = {
  fr: {
    ...
    sources: [
      ...
      { name: 'GloBI Bee-Plant', desc: 'Interactions abeilles-plantes mondiales (Noori et al.)', license: 'CC0' },
      ...
      { name: 'UKCEH Redhead', desc: 'Réseaux pollinisation Grande-Bretagne', license: 'OGL' },
      { name: 'CropPol', desc: 'Pollinisateurs des cultures agricoles', license: 'CC BY-NC-SA' },
      { name: 'Mangal', desc: 'Réseaux écologiques', license: 'CC0' },
      { name: 'Web of Life', desc: 'Réseaux plantes-pollinisateurs', license: 'Open' },
      { name: 'Bladmineerders', desc: 'Parasites des plantes d\'Europe : mineuses, galles, insectes (Ellis)', license: 'CC BY-NC-SA' },
    ],
  ...
  en: {
    ...
    stats: [
      { label: 'Documented interactions', value: '339,639' },
      { label: 'Plant species', value: '21,194' },
      { label: 'Insect species', value: '39,258' },
      { label: 'Integrated databases', value: '14' },
    ...
    sources: [
      ...
      { name: 'GloBI Bee-Plant', desc: 'Global bee-plant interactions (Noori et al.)', license: 'CC0' },
      ...
      { name: 'UKCEH Redhead', desc: 'UK pollination networks', license: 'OGL' },
      { name: 'CropPol', desc: 'Crop pollinator interactions', license: 'CC BY-NC-SA' },
      { name: 'Mangal', desc: 'Ecological networks', license: 'CC0' },
      { name: 'Web of Life', desc: 'Plant-pollinator networks', license: 'Open' },
      { name: 'Bladmineerders', desc: 'Plant Parasites of Europe: leafminers, galls, insects (Ellis)', license: 'CC BY-NC-SA' },
    ],
